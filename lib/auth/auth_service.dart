...
import 'package:kaappan/controlroom.dart';
import 'package:kaappan/policedb.dart';
import 'package:kaappan/ambulancedb.dart';
...
class AuthService {
  ...
  void redirectToDashboard(String role, BuildContext context) {
    if (role == "Admin") {
      Navigator.push(
          context, MaterialPageRoute(builder: (context) => ControlRoomDashboard()));
    } else if (role == "police") {
      Navigator.push(
